        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption welcome">
                    <h1 class="animated bounceInRight">Selamat Datang di FisipCare</h1>
                    <h3 class="animated bounceInLeft">Website Pengaduan Mahasiswa UNS</h3>
                </div>
            </div>
            <div class="item">
                <img src="images/2.jpg" alt="...">
                <div class="carousel-caption">
                    <h2 class="animated bounceInDown">Ayo Melapor</h2>
                </div>
            </div>
            <div class="item">
                <img src="images/3.jpg" alt="...">
                <div class="carousel-caption">
                    <h2 class="animated bounceInUp">Privasi Aman</h2>
                </div>
            </div>
        </div>
   ...
   <div class="main-content">
    ...
    foreach ($statement as $key) {
        ...
        <div class="panel-body card-shadow-2">
            <a class="media-left" href="#"><img class="img-circle img-sm form-shadow" src="images/avatar/<?php echo RandomAvatar(); ?>"></a>
            <div class="media-body">
                <div>
                    <h4 class="text-green profil-name" style="font-family: monospace;">Pengguna Anonim</h4>
                    <p class="text-muted text-sm"><i class="fa fa-th fa-fw"></i>  -  <?php echo $tanggal; ?></p>
                </div>
                <hr class="hr-nama">
                <p>
                    <?php echo htmlspecialchars($key['isi']); // Sanitasi output ?>
                </p>
                <p class="text-muted"><strong>Status:</strong> <?php echo htmlspecialchars($key['status']); // Menampilkan status laporan ?></p>
            </div>
            <!-- media body -->
        </div>
        <!-- panel body -->
